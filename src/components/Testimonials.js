...
const Testimonials = (props) => {
  ...
  return (
    ...
    <div className='w-[85vw] flex flex-col md:w-[700px] bg-white justify-center items-center mt-10 p-10
     transition-all duration-700 hover:shadow-xl'>
      ...
      <div className='flex text-3xl mt-5 gap-3 text-violet-400 font-bold mx-auto'>
       ...
       <div >
        <button onClick={surpriseMeHandler} className='bg-violet-400 hover:bg-violet-500 transition-all duration-200
            cursor-pointer px-10 py-2 font-bold rounded-md text-white text-lg'>
            surprise me
        </button>
       </div> 
